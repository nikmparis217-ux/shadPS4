...
void main()
{
    ...
    precise float _265 = uintBitsToFloat(ssbo_2_1.data[32u + buf1_dword_off]) * _111;
    precise float _267 = uintBitsToFloat(ssbo_2_1.data[33u + buf1_dword_off]) * _111;
    precise float _270 = uintBitsToFloat(ssbo_2_1.data[35u + buf1_dword_off]) * _111;
    precise float _271 = _270 + uintBitsToFloat(ssbo_2_1.data[47u + buf1_dword_off]);
    precise float _273 = uintBitsToFloat(ssbo_2_1.data[39u + buf1_dword_off]) * _112;
    precise float _274 = _273 + _271;
    precise float _276 = uintBitsToFloat(ssbo_2_1.data[36u + buf1_dword_off]) * _112;
    precise float _277 = _276 + _265;
    precise float _279 = uintBitsToFloat(ssbo_2_1.data[37u + buf1_dword_off]) * _112;
    precise float _280 = _279 + _267;
    float _281 = 1.0 / _274;
    precise float _283 = uintBitsToFloat(ssbo_2_1.data[44u + buf1_dword_off]) + _277;
    precise float _285 = uintBitsToFloat(ssbo_2_1.data[45u + buf1_dword_off]) + _280;
    precise float _286 = _281 * _283;
    precise float _287 = _281 * _285;
    precise float _288 = _195.w * _111;
    precise float _289 = _288 + _169.w;
    precise float _290 = _195.z * _111;
    precise float _291 = _290 + _169.z;
    precise float _292 = _195.y * _111;
    precise float _293 = _292 + _169.y;
    precise float _294 = _111 * _195.x;
    precise float _295 = _294 + _169.x;
    precise float _296 = _223.w * _112;
    precise float _297 = _296 + _289;
    precise float _298 = _223.z * _112;
    precise float _299 = _298 + _291;
    precise float _300 = _223.y * _112;
    precise float _301 = _300 + _293;
    precise float _302 = _112 * _223.x;
