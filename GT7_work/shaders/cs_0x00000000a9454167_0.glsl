...
void main()
{
    ...
    float _166 = min(uintBitsToFloat(_142), min(min(uintBitsToFloat(_138), uintBitsToFloat(_135)), uintBitsToFloat(_145)));
    ...
    float _190 = min(uintBitsToFloat(subgroupBroadcast(floatBitsToUint(min(uintBitsToFloat(_173), min(min(uintBitsToFloat(_145), min(uintBitsToFloat(_138), uintBitsToFloat(_135))), uintBitsToFloat(_142)))), ((gl_SubgroupInvocationID & 255u) | 0u) ^ 8u)), min(uintBitsToFloat(_173), _166));
    ...
    if (_153)
    {
        ...
        uint _227 = subgroupBroadcast(floatBitsToUint(min(uintBitsToFloat(_216), _190)), ((gl_SubgroupInvocationID & 255u) | 0u) ^ 16u);
        if (_153 && (_127 > _211))
        {
            ssbo_1_1.data[_211 + buf0_dword_off] = _191;
        }
        float _237 = min(uintBitsToFloat(_227), min(uintBitsToFloat(_216), _190));
        ...
        if (_241)
        {
            ...
            float _276 = min(uintBitsToFloat(_267), _237);
            ...
            if (_281)
            {
                ...
                if (_281 && (_127 > _303))
                {
                    ssbo_1_1.data[_303 + buf0_dword_off] = floatBitsToUint(min(uintBitsToFloat(_279), _276));
                }
            }
        }
    }
