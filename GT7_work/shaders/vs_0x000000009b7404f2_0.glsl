...
void main()
{
    ...
    precise float _530 = uintBitsToFloat(_317) * uintBitsToFloat(_279);
    ...
    precise float _545 = (-_531) * uintBitsToFloat(srt_flatbuf_1.data[44u]);
    precise float _546 = _545 + _527;
    precise float _549 = uintBitsToFloat(srt_flatbuf_1.data[43u]) * uintBitsToFloat(_260);
    precise float _550 = _549 + _535;
    precise float _553 = uintBitsToFloat(srt_flatbuf_1.data[27u]) * uintBitsToFloat(_315);
    precise float _556 = uintBitsToFloat(srt_flatbuf_1.data[27u]) * uintBitsToFloat(_295);
    precise float _559 = uintBitsToFloat(_260) * uintBitsToFloat(_317);
    precise float _560 = _559 + _539;
    precise float _562 = _540 * _542;
    precise float _563 = _562 + (-_430);
    precise float _564 = _494 * _546;
    precise float _565 = _564 + _457;
    precise float _568 = uintBitsToFloat(srt_flatbuf_1.data[27u]) * uintBitsToFloat(_277);
    precise float _571 = uintBitsToFloat(srt_flatbuf_1.data[25u]) * uintBitsToFloat(_315);
    precise float _574 = uintBitsToFloat(srt_flatbuf_1.data[25u]) * uintBitsToFloat(_295);
    precise float _577 = uintBitsToFloat(srt_flatbuf_1.data[26u]) * uintBitsToFloat(_315);
    precise float _580 = uintBitsToFloat(srt_flatbuf_1.data[26u]) * uintBitsToFloat(_295);
    precise float _583 = uintBitsToFloat(srt_flatbuf_1.data[44u]) * (-_560);
    precise float _584 = _583 + _550;
    precise float _587 = uintBitsToFloat(srt_flatbuf_1.data[31u]) * uintBitsToFloat(_316);
    precise float _588 = _587 + _553;
    precise float _591 = uintBitsToFloat(srt_flatbuf_1.data[31u]) * uintBitsToFloat(_296);
    precise float _592 = _591 + _556;
    precise float _593 = _563 * _563;
    precise float _595 = _540 * _565;
    precise float _596 = _595 + (-_457);
    precise float _597 = _494 * _584;
    precise float _598 = _597 + _477;
    precise float _601 = uintBitsToFloat(_317) * uintBitsToFloat(srt_flatbuf_1.data[35u]);
    precise float _602 = _601 + _588;
    precise float _605 = uintBitsToFloat(_278) * uintBitsToFloat(srt_flatbuf_1.data[31u]);
    precise float _606 = _605 + _568;
    precise float _609 = uintBitsToFloat(srt_flatbuf_1.data[27u]) * uintBitsToFloat(_258);
    precise float _612 = uintBitsToFloat(srt_flatbuf_1.data[25u]) * uintBitsToFloat(_277);
    precise float _615 = uintBitsToFloat(srt_flatbuf_1.data[35u]) * uintBitsToFloat(_297);
    precise float _616 = _615 + _592;
    precise float _619 = uintBitsToFloat(srt_flatbuf_1.data[29u]) * uintBitsToFloat(_316);
    precise float _620 = _619 + _571;
    precise float _623 = uintBitsToFloat(_316) * uintBitsToFloat(srt_flatbuf_1.data[30u]);
    precise float _624 = _623 + _577;
    precise float _627 = uintBitsToFloat(srt_flatbuf_1.data[26u]) * uintBitsToFloat(_277);
    precise float _630 = uintBitsToFloat(srt_flatbuf_1.data[29u]) * uintBitsToFloat(_296);
    precise float _631 = _630 + _574;
    precise float _634 = uintBitsToFloat(_296) * uintBitsToFloat(srt_flatbuf_1.data[30u]);
    precise float _635 = _634 + _580;
    precise float _636 = _596 * _596;
    precise float _637 = _636 + _593;
    precise float _639 = _540 * _598;
    precise float _640 = _639 + (-_477);
    precise float _643 = uintBitsToFloat(_318) * uintBitsToFloat(srt_flatbuf_1.data[39u]);
    precise float _644 = _643 + _602;
    precise float _647 = uintBitsToFloat(srt_flatbuf_1.data[25u]) * uintBitsToFloat(_258);
    precise float _650 = uintBitsToFloat(srt_flatbuf_1.data[39u]) * uintBitsToFloat(_298);
    precise float _651 = _650 + _616;
    precise float _654 = uintBitsToFloat(srt_flatbuf_1.data[35u]) * uintBitsToFloat(_279);
    precise float _655 = _654 + _606;
    precise float _658 = uintBitsToFloat(srt_flatbuf_1.data[31u]) * uintBitsToFloat(_259);
    precise float _659 = _658 + _609;
    precise float _662 = uintBitsToFloat(srt_flatbuf_1.data[33u]) * uintBitsToFloat(_317);
    precise float _663 = _662 + _620;
    precise float _666 = uintBitsToFloat(srt_flatbuf_1.data[33u]) * uintBitsToFloat(_297);
    precise float _667 = _666 + _631;
    precise float _670 = uintBitsToFloat(srt_flatbuf_1.data[29u]) * uintBitsToFloat(_278);
    precise float _671 = _670 + _612;
    precise float _674 = uintBitsToFloat(srt_flatbuf_1.data[34u]) * uintBitsToFloat(_317);
    precise float _675 = _674 + _624;
    precise float _678 = uintBitsToFloat(srt_flatbuf_1.data[26u]) * uintBitsToFloat(_258);
    precise float _681 = uintBitsToFloat(srt_flatbuf_1.data[34u]) * uintBitsToFloat(_297);
    precise float _682 = _681 + _635;
    precise float _685 = uintBitsToFloat(srt_flatbuf_1.data[30u]) * uintBitsToFloat(_278);
    precise float _686 = _685 + _627;
    precise float _687 = _640 * _640;
    precise float _688 = _687 + _637;
    precise float _689 = _651 * _430;
    precise float _690 = _689 + _644;
    precise float _693 = uintBitsToFloat(srt_flatbuf_1.data[39u]) * uintBitsToFloat(_280);
    precise float _694 = _693 + _655;
    precise float _697 = uintBitsToFloat(srt_flatbuf_1.data[35u]) * uintBitsToFloat(_260);
    precise float _698 = _697 + _659;
    precise float _701 = uintBitsToFloat(srt_flatbuf_1.data[37u]) * uintBitsToFloat(_318);
    precise float _702 = _701 + _663;
    precise float _705 = uintBitsToFloat(srt_flatbuf_1.data[37u]) * uintBitsToFloat(_298);
    precise float _706 = _705 + _667;
    precise float _709 = uintBitsToFloat(srt_flatbuf_1.data[33u]) * uintBitsToFloat(_279);
    precise float _710 = _709 + _671;
    precise float _713 = uintBitsToFloat(srt_flatbuf_1.data[29u]) * uintBitsToFloat(_259);
    precise float _714 = _713 + _647;
    precise float _717 = uintBitsToFloat(srt_flatbuf_1.data[38u]) * uintBitsToFloat(_318);
    precise float _718 = _717 + _675;
    precise float _721 = uintBitsToFloat(_279) * uintBitsToFloat(srt_flatbuf_1.data[34u]);
    precise float _722 = _721 + _686;
    precise float _725 = uintBitsToFloat(srt_flatbuf_1.data[38u]) * uintBitsToFloat(_298);
    precise float _726 = _725 + _682;
    precise float _729 = uintBitsToFloat(srt_flatbuf_1.data[30u]) * uintBitsToFloat(_259);
    precise float _730 = _729 + _678;
    precise float _732 = _457 * _694;
    precise float _733 = _732 + _690;
    precise float _734 = _430 * _706;
    precise float _735 = _734 + _702;
    precise float _738 = uintBitsToFloat(_260) * uintBitsToFloat(srt_flatbuf_1.data[34u]);
    precise float _739 = _738 + _730;
    precise float _742 = uintBitsToFloat(srt_flatbuf_1.data[39u]) * uintBitsToFloat(_261);
    precise float _743 = _742 + _698;
    precise float _746 = uintBitsToFloat(srt_flatbuf_1.data[37u]) * uintBitsToFloat(_280);
    precise float _747 = _746 + _710;
    precise float _750 = uintBitsToFloat(srt_flatbuf_1.data[33u]) * uintBitsToFloat(_260);
    precise float _751 = _750 + _714;
    precise float _752 = _726 * _430;
    precise float _753 = _752 + _718;
    precise float _756 = uintBitsToFloat(srt_flatbuf_1.data[38u]) * uintBitsToFloat(_280);
    precise float _757 = _756 + _722;
    float _758 = ((((srt_flatbuf_1.data[23u] >> 3u) & 1u) == 1u) ? true : false) ? inversesqrt(_688) : 0.0;
    precise float _759 = _477 * _743;
    precise float _760 = _759 + _733;
    precise float _761 = _747 * _457;
    precise float _762 = _761 + _735;
    precise float _765 = uintBitsToFloat(srt_flatbuf_1.data[37u]) * uintBitsToFloat(_261);
    precise float _766 = _765 + _751;
    precise float _767 = _757 * _457;
    precise float _768 = _767 + _753;
    precise float _771 = uintBitsToFloat(srt_flatbuf_1.data[38u]) * uintBitsToFloat(_261);
    precise float _772 = _771 + _739;
    precise float _774 = (-_494) * _758;
    precise float _775 = _774 + _760;
    precise float _776 = _766 * _477;
    precise float _777 = _776 + _762;
    precise float _778 = _772 * _477;
    precise float _779 = _778 + _768;
    gl_Position.x = _777;
    gl_Position.y = _779;
    gl_Position.z = _775;
    gl_Position.w = _494;
