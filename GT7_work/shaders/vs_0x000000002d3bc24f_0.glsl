...
void main()
{
    ...
    precise float _643 = uintBitsToFloat(srt_flatbuf_1.data[26u]) * uintBitsToFloat(_258);
    precise float _644 = _612 * _612;
    precise float _645 = _644 + _609;
    precise float _648 = uintBitsToFloat(_318) * uintBitsToFloat(srt_flatbuf_1.data[39u]);
    precise float _649 = _648 + _616;
    precise float _652 = uintBitsToFloat(srt_flatbuf_1.data[25u]) * uintBitsToFloat(_258);
    ...
    float _689 = inversesqrt(_645);
    precise float _690 = _430 * _656;
    precise float _691 = _690 + _649;
    ...
    precise float _731 = _730 + _643;
    precise float _733 = 0.5 * _689;
    precise float _734 = _733 + _689;
    precise float _735 = _457 * _699;
    precise float _736 = _735 + _691;
    precise float _739 = uintBitsToFloat(_260) * uintBitsToFloat(srt_flatbuf_1.data[34u]);
    precise float _740 = _739 + _731;
    precise float _743 = uintBitsToFloat(srt_flatbuf_1.data[39u]) * uintBitsToFloat(_261);
    precise float _744 = _743 + _703;
    precise float _745 = _707 * _430;
    precise float _746 = _745 + _695;
    precise float _749 = uintBitsToFloat(srt_flatbuf_1.data[37u]) * uintBitsToFloat(_280);
    precise float _750 = _749 + _711;
    precise float _753 = uintBitsToFloat(srt_flatbuf_1.data[33u]) * uintBitsToFloat(_260);
    precise float _754 = _753 + _715;
    precise float _755 = _723 * _430;
    precise float _756 = _755 + _719;
    precise float _759 = uintBitsToFloat(srt_flatbuf_1.data[38u]) * uintBitsToFloat(_280);
    precise float _760 = _759 + _727;
    float _761 = ((((srt_flatbuf_1.data[23u] >> 3u) & 1u) == 1u) ? true : false) ? _734 : 0.0;
    precise float _762 = _744 * _477;
    precise float _763 = _762 + _736;
    precise float _764 = _750 * _457;
    precise float _765 = _764 + _746;
    precise float _768 = uintBitsToFloat(srt_flatbuf_1.data[37u]) * uintBitsToFloat(_261);
    precise float _769 = _768 + _754;
    precise float _770 = _760 * _457;
    precise float _771 = _770 + _756;
    precise float _774 = uintBitsToFloat(srt_flatbuf_1.data[38u]) * uintBitsToFloat(_261);
    precise float _775 = _774 + _740;
    precise float _777 = _761 * (-_494);
    precise float _778 = _777 + _763;
    precise float _779 = _769 * _477;
    precise float _780 = _779 + _765;
    precise float _781 = _775 * _477;
    precise float _782 = _781 + _771;
    gl_Position.x = _780;
    gl_Position.y = _782;
    gl_Position.z = _778;
    gl_Position.w = _494;
