...
void main()
{
    ...
    {
        ssbo_1_1.data[_113 + buf0_dword_off] = floatBitsToUint(min(uintBitsToFloat(ssbo_1_1.data[_102 + buf0_dword_off]), uintBitsToFloat(ssbo_1_1.data[(_102 + 1u) + buf0_dword_off])));
    }
}
