...
void main()
{
    ...
    frag_color0.x = fma(_111, gl_BaryCoordEXT.z, fma(_87, gl_BaryCoordEXT.y, fs_in_attr0_p[0u].w));
    frag_color0.y = fma(_105, gl_BaryCoordEXT.z, fma(_81, gl_BaryCoordEXT.y, fs_in_attr0_p[0u].z));
    frag_color0.z = fma(_99, gl_BaryCoordEXT.z, fma(_75, gl_BaryCoordEXT.y, fs_in_attr0_p[0u].y));
    frag_color0.w = fma(_93, gl_BaryCoordEXT.z, fma(_68, gl_BaryCoordEXT.y, fs_in_attr0_p[0u].x));
}
