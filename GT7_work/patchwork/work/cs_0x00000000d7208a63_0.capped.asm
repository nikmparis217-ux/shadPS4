...
%buf3_dword_off = OpShiftRightLogical %u32_id %buf3_off %u32_id_2
      ...
      %ud_10 = OpLoad %u32_id %163
        ...
        %176 = OpUGreaterThan %bool_id %ud_0 %175
         ...
         %63 = OpLabel
        %178 = OpIMul %u32_id %175 %u32_id_21
       ...
       %gtc1039 = OpPhi %u32_id %u32_id_0 %63 %gtc1040 %105
       ...
       %gtc1040 = OpIAdd %u32_id %gtc1039 %u32_id_1
       %gtc1041 = OpUGreaterThanEqual %bool_id %gtc1039 %gtcap_1000
       %gtc1042 = OpLogicalOr %bool_id %227 %gtc1041
               OpBranchConditional %gtc1042 %106 %66
         %66 = OpLabel
               OpBranch %67
         %67 = OpLabel
       ...
       %gtc1043 = OpPhi %u32_id %u32_id_0 %66 %gtc1044 %71
        ...
        %274 = OpIEqual %bool_id %231 %u32_id_15
        %275 = OpSelect %u32_id %274 %207 %272
        %276 = OpIEqual %bool_id %231 %u32_id_16
        %277 = OpSelect %u32_id %276 %206 %275
        %279 = OpIEqual %bool_id %231 %u32_id_17
        %280 = OpSelect %u32_id %279 %205 %277
        %282 = OpIEqual %bool_id %231 %u32_id_18
        %283 = OpSelect %u32_id %282 %204 %280
        %285 = OpIEqual %bool_id %231 %u32_id_19
        %286 = OpSelect %u32_id %285 %203 %283
        %288 = OpIEqual %bool_id %231 %u32_id_20
        %289 = OpSelect %u32_id %288 %202 %286
        %290 = OpIEqual %bool_id %231 %u32_id_21
        %291 = OpSelect %u32_id %290 %201 %289
        ...
        %321 = OpPhi %u32_id %320 %69 %228 %68
               OpBranch %71
         %71 = OpLabel
       %gtc1044 = OpIAdd %u32_id %gtc1043 %u32_id_1
       %gtc1047 = OpULessThan %bool_id %gtc1043 %gtcap_1000
       %gtc1046 = OpLogicalAnd %bool_id %235 %gtc1047
               OpBranchConditional %gtc1046 %67 %72
         %72 = OpLabel
       ...
       %gtc1048 = OpPhi %u32_id %u32_id_0 %88 %gtc1049 %93
        ...
        %693 = OpPhi %u32_id %599 %91 %589 %90
               OpBranch %93
         %93 = OpLabel
       %gtc1049 = OpIAdd %u32_id %gtc1048 %u32_id_1
       %gtc1052 = OpULessThan %bool_id %gtc1048 %gtcap_1000
       %gtc1051 = OpLogicalAnd %bool_id %597 %gtc1052
               OpBranchConditional %gtc1051 %89 %94
         %94 = OpLabel
       ...
       %gtc1053 = OpPhi %u32_id %u32_id_0 %96 %gtc1054 %101
        ...
        %846 = OpPhi %u32_id %752 %99 %742 %98
               OpBranch %101
        %101 = OpLabel
       %gtc1054 = OpIAdd %u32_id %gtc1053 %u32_id_1
       %gtc1057 = OpULessThan %bool_id %gtc1053 %gtcap_1000
       %gtc1056 = OpLogicalAnd %bool_id %750 %gtc1057
               OpBranchConditional %gtc1056 %97 %102
        %102 = OpLabel
               OpBranch %103
        %103 = OpLabel
       ...
       %1035 = OpLogicalAnd %bool_id %176 %1034
        ...
        %107 = OpLabel
       %1036 = OpIMul %u32_id %909 %u32_id_21
