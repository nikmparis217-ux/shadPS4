...
%buf1_dword_off = OpShiftRightLogical %u32_id %buf1_off %u32_id_2
       ...
       %gtc2364 = OpPhi %u32_id %u32_id_0 %79 %gtc2365 %92
               OpLoopMerge %93 %92 None
               OpBranch %81
         %81 = OpLabel
        %294 = OpULessThan %bool_id %293 %140
        %295 = OpLogicalNot %bool_id %294
       %gtc2365 = OpIAdd %u32_id %gtc2364 %u32_id_1
       %gtc2366 = OpUGreaterThanEqual %bool_id %gtc2364 %gtcap_1000
       %gtc2367 = OpLogicalOr %bool_id %295 %gtc2366
               OpBranchConditional %gtc2367 %93 %82
         %82 = OpLabel
       ...
       %gtc2368 = OpPhi %u32_id %u32_id_0 %82 %gtc2369 %90
               OpLoopMerge %91 %90 None
               OpBranch %84
         %84 = OpLabel
        %318 = OpULessThan %bool_id %317 %140
        %319 = OpLogicalNot %bool_id %318
       %gtc2369 = OpIAdd %u32_id %gtc2368 %u32_id_1
       %gtc2370 = OpUGreaterThanEqual %bool_id %gtc2368 %gtcap_1000
       %gtc2371 = OpLogicalOr %bool_id %319 %gtc2370
               OpBranchConditional %gtc2371 %91 %85
         %85 = OpLabel
       ...
       %gtc2363 = OpULessThan %bool_id %gtc2359 %gtcap_1000
       %gtc2362 = OpLogicalAnd %bool_id %521 %gtc2363
       ...
       %gtc2372 = OpPhi %u32_id %u32_id_0 %96 %gtc2373 %99
        ...
        %743 = OpSLessThan %bool_id %606 %u32_id_63
               OpBranch %99
         %99 = OpLabel
       %gtc2373 = OpIAdd %u32_id %gtc2372 %u32_id_1
       %gtc2376 = OpULessThan %bool_id %gtc2372 %gtcap_1000
       %gtc2375 = OpLogicalAnd %bool_id %743 %gtc2376
               OpBranchConditional %gtc2375 %97 %100
        %100 = OpLabel
