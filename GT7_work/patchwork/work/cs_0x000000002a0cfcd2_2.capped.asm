...
%buf1_dword_off = OpShiftRightLogical %u32_id %buf1_off %u32_id_2
       ...
       %ud_3 = OpLoad %u32_id %120
        ...
        %gtc918 = OpPhi %u32_id %u32_id_0 %75 %gtc919 %85
               OpLoopMerge %86 %85 None
               OpBranch %77
         %77 = OpLabel
        %273 = OpSLessThan %bool_id %272 %256
        %274 = OpLogicalNot %bool_id %273
        %gtc919 = OpIAdd %u32_id %gtc918 %u32_id_1
        %gtc920 = OpUGreaterThanEqual %bool_id %gtc918 %gtcap_1000
        %gtc921 = OpLogicalOr %bool_id %274 %gtc920
               OpBranchConditional %gtc921 %86 %78
         %78 = OpLabel
        ...
        %gtc922 = OpPhi %u32_id %u32_id_0 %86 %gtc923 %98
               OpLoopMerge %99 %98 None
               OpBranch %88
         %88 = OpLabel
        %517 = OpSLessThan %bool_id %516 %512
        %518 = OpLogicalNot %bool_id %517
        %gtc923 = OpIAdd %u32_id %gtc922 %u32_id_1
        %gtc924 = OpUGreaterThanEqual %bool_id %gtc922 %gtcap_1000
        %gtc925 = OpLogicalOr %bool_id %518 %gtc924
               OpBranchConditional %gtc925 %99 %89
         %89 = OpLabel
