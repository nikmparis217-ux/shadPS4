...
%buf3_dword_off = OpShiftRightLogical %u32_id %buf3_off %u32_id_2
       ...
       %ud_2 = OpLoad %u32_id %119
        ...
        %gtc575 = OpPhi %u32_id %u32_id_0 %64 %gtc576 %68
        ...
        %gtc576 = OpIAdd %u32_id %gtc575 %u32_id_1
        %gtc577 = OpUGreaterThanEqual %bool_id %gtc575 %gtcap_1000
        %gtc578 = OpLogicalOr %bool_id %166 %gtc577
               OpBranchConditional %gtc578 %69 %67
         %67 = OpLabel
               OpBranch %68
         %68 = OpLabel
