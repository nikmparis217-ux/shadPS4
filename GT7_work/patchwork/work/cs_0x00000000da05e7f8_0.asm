...
; Schema: 0
        ...
        %109 = OpExtInstImport "GLSL.std.450"
          ...
          %1 = OpString "0xda05e7f8"
               ...
               OpDecorate %cs_sampsgpr_24 Binding 11
...
%_arr_60_u32_id_9 = OpTypeArray %60 %u32_id_9
%_ptr_UniformConstant__arr_60_u32_id_9 = OpTypePointer UniformConstant %_arr_60_u32_id_9
         %65 = OpTypeSampler
...
%srt_flatbuf = OpVariable %_ptr_StorageBuffer__struct_52 StorageBuffer
   ...
   %cs_img31 = OpVariable %_ptr_UniformConstant__arr_60_u32_id_9 UniformConstant
