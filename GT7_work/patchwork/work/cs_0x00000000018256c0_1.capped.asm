...
%buf1_dword_off = OpShiftRightLogical %u32_id %buf1_off %u32_id_2
       ...
       %ud_3 = OpLoad %u32_id %119
        ...
        %gtc913 = OpPhi %u32_id %u32_id_0 %73 %gtc914 %83
               OpLoopMerge %84 %83 None
               OpBranch %75
         %75 = OpLabel
        %269 = OpSLessThan %bool_id %268 %252
        %270 = OpLogicalNot %bool_id %269
        %gtc914 = OpIAdd %u32_id %gtc913 %u32_id_1
        %gtc915 = OpUGreaterThanEqual %bool_id %gtc913 %gtcap_1000
        %gtc916 = OpLogicalOr %bool_id %270 %gtc915
               OpBranchConditional %gtc916 %84 %76
         %76 = OpLabel
        ...
        %gtc917 = OpPhi %u32_id %u32_id_0 %84 %gtc918 %96
               OpLoopMerge %97 %96 None
               OpBranch %86
         %86 = OpLabel
        %504 = OpSLessThan %bool_id %503 %499
        %505 = OpLogicalNot %bool_id %504
        %gtc918 = OpIAdd %u32_id %gtc917 %u32_id_1
        %gtc919 = OpUGreaterThanEqual %bool_id %gtc917 %gtcap_1000
        %gtc920 = OpLogicalOr %bool_id %505 %gtc919
               OpBranchConditional %gtc920 %97 %87
         %87 = OpLabel
