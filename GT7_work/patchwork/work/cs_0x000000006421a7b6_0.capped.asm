...
%buf6_dword_off = OpShiftRightLogical %u32_id %buf6_off %u32_id_2
       ...
       %gtc1850 = OpUGreaterThanEqual %bool_id %gtc1848 %gtcap_1000
       ...
       %gtc1854 = OpUGreaterThanEqual %bool_id %gtc1852 %gtcap_1000
       ...
       %gtc1860 = OpULessThan %bool_id %gtc1856 %gtcap_1000
       %gtc1859 = OpLogicalAnd %bool_id %1839 %gtc1860
