...
%buf0_dword_off = OpShiftRightLogical %u32_id %buf0_off %u32_id_2
       ...
       %ud_1 = OpLoad %u32_id %87
        ...
        %gtc211 = OpPhi %u32_id %u32_id_0 %61 %gtc212 %73
        ...
        %gtc212 = OpIAdd %u32_id %gtc211 %u32_id_1
        %gtc213 = OpUGreaterThanEqual %bool_id %gtc211 %gtcap_1000
        %gtc214 = OpLogicalOr %bool_id %119 %gtc213
               OpBranchConditional %gtc214 %74 %64
         %64 = OpLabel
