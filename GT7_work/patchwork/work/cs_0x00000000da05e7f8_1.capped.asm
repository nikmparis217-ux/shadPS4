...
; Schema: 0
        ...
        %108 = OpExtInstImport "GLSL.std.450"
               ...
               OpEntryPoint GLCompute %68 "main" %push_data %gl_WorkGroupID %gl_LocalInvocationID %srt_flatbuf %cs_img16 %cs_img31 %cs_sampsgpr_24
               OpExecutionMode %68 LocalSize 8 8 1
               OpExecutionMode %68 SignedZeroInfNanPreserve 32
          %1 = OpString "0xda05e7f8"
               ...
               OpDecorate %cs_sampsgpr_24 Binding 3
...
%_arr_60_u32_id_1 = OpTypeArray %60 %u32_id_1
%_ptr_UniformConstant__arr_60_u32_id_1 = OpTypePointer UniformConstant %_arr_60_u32_id_1
         %64 = OpTypeSampler
%_ptr_UniformConstant_64 = OpTypePointer UniformConstant %64
         %67 = OpTypeFunction %void_id
...
%srt_flatbuf = OpVariable %_ptr_StorageBuffer__struct_52 StorageBuffer
   ...
   %cs_img31 = OpVariable %_ptr_UniformConstant__arr_60_u32_id_1 UniformConstant
%cs_sampsgpr_24 = OpVariable %_ptr_UniformConstant_64 UniformConstant
         %68 = OpFunction %void_id None %67
         %69 = OpLabel
         %79 = OpAccessChain %_ptr_PushConstant_u32_id %push_data %u32_id_4 %u32_id_0
       %ud_0 = OpLoad %u32_id %79
         %81 = OpAccessChain %_ptr_PushConstant_u32_id %push_data %u32_id_4 %u32_id_1
       %ud_1 = OpLoad %u32_id %81
         %84 = OpAccessChain %_ptr_PushConstant_u32_id %push_data %u32_id_4 %u32_id_2
       %ud_2 = OpLoad %u32_id %84
         %87 = OpAccessChain %_ptr_PushConstant_u32_id %push_data %u32_id_4 %u32_id_3
       %ud_3 = OpLoad %u32_id %87
         %89 = OpLoad %u32vec3_id %gl_LocalInvocationID
         %90 = OpCompositeExtract %u32_id %89 0
         %91 = OpLoad %u32vec3_id %gl_LocalInvocationID
         %92 = OpCompositeExtract %u32_id %91 1
         %93 = OpLoad %u32vec3_id %gl_WorkGroupID
         %94 = OpCompositeExtract %u32_id %93 0
         %95 = OpLoad %u32vec3_id %gl_WorkGroupID
         %96 = OpCompositeExtract %u32_id %95 1
         %97 = OpLoad %u32vec3_id %gl_WorkGroupID
         %98 = OpCompositeExtract %u32_id %97 2
         %99 = OpShiftLeftLogical %u32_id %94 %u32_id_3
        %100 = OpShiftLeftLogical %u32_id %96 %u32_id_3
        %101 = OpIAdd %u32_id %99 %90
        %102 = OpIAdd %u32_id %100 %92
        %103 = OpCompositeConstruct %u32vec2_id %ud_0 %ud_1
        %106 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_30
        %107 = OpLoad %u32_id %106
        %109 = OpExtInst %u32_id %108 UMax %101 %102
        %110 = OpUGreaterThan %bool_id %107 %109
               OpSelectionMerge %75 None
               OpBranchConditional %110 %70 %75
         %70 = OpLabel
        %111 = OpConvertUToF %f32_id %101
        %113 = OpIMul %u32_id %98 %u32_id_12
        %115 = OpIAdd %u32_id %113 %u32_id_144
        %116 = OpShiftRightLogical %u32_id %115 %u32_id_2
        %117 = OpCompositeConstruct %u32vec2_id %ud_0 %ud_1
        %118 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %119 = OpLoad %u32_id %118
        %120 = OpIAdd %u32_id %116 %u32_id_1
        %121 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %122 = OpLoad %u32_id %121
        %123 = OpShiftRightLogical %u32_id %113 %u32_id_2
        %124 = OpCompositeConstruct %u32vec2_id %ud_0 %ud_1
        %125 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %126 = OpLoad %u32_id %125
        %127 = OpIAdd %u32_id %123 %u32_id_1
        %128 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %129 = OpLoad %u32_id %128
        %131 = OpIAdd %u32_id %113 %u32_id_72
        %133 = OpIAdd %u32_id %113 %u32_id_152
        %134 = OpShiftRightLogical %u32_id %131 %u32_id_2
        %135 = OpCompositeConstruct %u32vec2_id %ud_0 %ud_1
        %136 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %137 = OpLoad %u32_id %136
        %138 = OpIAdd %u32_id %134 %u32_id_1
        %139 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %140 = OpLoad %u32_id %139
        %141 = OpShiftRightLogical %u32_id %133 %u32_id_2
        %142 = OpCompositeConstruct %u32vec2_id %ud_0 %ud_1
        %143 = OpAccessChain %_ptr_StorageBuffer_u32_id %srt_flatbuf %u32_id_0 %u32_id_0
        %144 = OpLoad %u32_id %143
        %146 = OpIAdd %u32_id %113 %u32_id_8
        %147 = OpConvertUToF %f32_id %102
        ...
        %153 = OpIAdd %u32_id %113 %u32_id_80
        %154 = OpBitcast %f32_id %126
        %155 = OpBitcast %f32_id %119
        %156 = OpFMul %f32_id %154 %111
        ...
        %184 = OpExtInst %f32_id %108 InverseSqrt %183
        ...
        %205 = OpExtInst %f32_id %108 InverseSqrt %204
        ...
        %220 = OpFAdd %f32_id %219 %211
               OpBranch %71
         %71 = OpLabel
        %221 = OpPhi %u32_id %u32_id_0 %70 %368 %73
        %222 = OpPhi %u32_id %u32_id_0 %70 %362 %73
        %223 = OpPhi %u32_id %u32_id_0 %70 %365 %73
        %224 = OpPhi %u32_id %u32_id_0 %70 %357 %73
        %gtc398 = OpPhi %u32_id %u32_id_0 %70 %gtc399 %73
        ...
        %269 = OpExtInst %f32_id %108 FAbs %264
        %270 = OpExtInst %f32_id %108 FAbs %261
        %271 = OpExtInst %f32_id %108 FAbs %258
        ...
        %278 = OpExtInst %f32_id %108 FAbs %277
        ...
        %287 = OpExtInst %f32_id %108 FAbs %264
        %288 = OpExtInst %f32_id %108 FAbs %261
        %289 = OpExtInst %f32_id %108 FAbs %258
        ...
        %300 = OpExtInst %f32_id %108 FAbs %264
        %301 = OpExtInst %f32_id %108 FAbs %261
        %302 = OpExtInst %f32_id %108 FAbs %258
        ...
        %310 = OpExtInst %f32_id %108 Fma %295 %280 %f32_id_1_5
        %311 = OpExtInst %f32_id %108 Fma %308 %280 %f32_id_1_5
        %312 = OpExtInst %f32_id %108 FAbs %258
        %313 = OpExtInst %f32_id %108 FAbs %264
        %314 = OpExtInst %f32_id %108 FAbs %261
        %315 = OpExtInst %f32_id %108 FMax %313 %314
        %316 = OpExtInst %f32_id %108 FMax %312 %315
        ...
        %326 = OpExtInst %f32_id %108 FAbs %264
        %327 = OpExtInst %f32_id %108 FAbs %261
        %328 = OpExtInst %f32_id %108 FAbs %258
        ...
        %337 = OpExtInst %f32_id %108 Log2 %336
        ...
        %346 = OpExtInst %f32_id %108 Floor %345
        %348 = OpExtInst %f32_id %108 Fma %346 %f32_id_n2 %334
        %349 = OpCompositeConstruct %f32vec3_id %342 %343 %348
        %350 = OpLoad %56 %cs_img16
        %351 = OpLoad %64 %cs_sampsgpr_24
        ...
        %368 = OpBitcast %u32_id %367
               OpBranch %73
         %73 = OpLabel
        %gtc399 = OpIAdd %u32_id %gtc398 %u32_id_1
        %gtc402 = OpULessThan %bool_id %gtc398 %gtcap_1000
        %gtc401 = OpLogicalAnd %bool_id %359 %gtc402
               OpBranchConditional %gtc401 %71 %74
         %74 = OpLabel
        ...
        %390 = OpIAdd %u32_id %98 %383
        %391 = OpCompositeConstruct %f32vec4_id %385 %389 %387 %f32_id_0
        %392 = OpCompositeConstruct %u32vec3_id %101 %102 %390
