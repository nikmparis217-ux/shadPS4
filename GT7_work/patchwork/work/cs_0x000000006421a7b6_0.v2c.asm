...
%buf6_dword_off = OpShiftRightLogical %u32_id %buf6_off %u32_id_2
       ...
       %gtc1848 = OpPhi %u32_id %u32_id_0 %82 %gtc1849 %87
               OpLoopMerge %88 %87 None
               OpBranch %84
         %84 = OpLabel
        %436 = OpLogicalNot %bool_id %435
       %gtc1850 = OpUGreaterThanEqual %bool_id %gtc1848 %gt_lim100000
       %gtc1851 = OpLogicalOr %bool_id %436 %gtc1850
               OpBranchConditional %gtc1851 %88 %85
         %85 = OpLabel
        ...
        %467 = OpLogicalAnd %bool_id %438 %466
               OpBranch %87
         %87 = OpLabel
       %gtc1849 = OpIAdd %u32_id %gtc1848 %u32_id_1
       ...
       %gtc1852 = OpPhi %u32_id %u32_id_0 %90 %gtc1853 %96
               OpLoopMerge %97 %96 None
               OpBranch %92
         %92 = OpLabel
        %479 = OpLogicalNot %bool_id %478
       %gtc1854 = OpUGreaterThanEqual %bool_id %gtc1852 %gt_lim100000
       %gtc1855 = OpLogicalOr %bool_id %479 %gtc1854
               OpBranchConditional %gtc1855 %97 %93
         %93 = OpLabel
        ...
        %520 = OpLogicalNot %bool_id %519
         ...
         %95 = OpLabel
               OpBranch %96
         %96 = OpLabel
       %gtc1853 = OpIAdd %u32_id %gtc1852 %u32_id_1
       ...
       %gtc1856 = OpPhi %u32_id %u32_id_0 %121 %gtc1857 %128
       ...
       %1839 = OpLogicalAnd %bool_id %1838 %1838
               OpBranch %128
        %128 = OpLabel
       %gtc1857 = OpIAdd %u32_id %gtc1856 %u32_id_1
       %gtc1858 = OpULessThan %bool_id %gtc1856 %gt_lim100000
       %gtc1859 = OpLogicalAnd %bool_id %1839 %gtc1858
               OpBranchConditional %gtc1859 %122 %129
        %129 = OpLabel
