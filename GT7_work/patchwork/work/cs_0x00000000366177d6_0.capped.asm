...
%buf1_dword_off = OpShiftRightLogical %u32_id %buf1_off %u32_id_2
       ...
       %gtc1874 = OpPhi %u32_id %u32_id_0 %70 %gtc1875 %83
       ...
       %gtc1879 = OpPhi %u32_id %u32_id_0 %72 %gtc1880 %81
               OpLoopMerge %82 %81 None
               OpBranch %74
         %74 = OpLabel
        %242 = OpULessThan %bool_id %241 %127
        %243 = OpLogicalNot %bool_id %242
       %gtc1880 = OpIAdd %u32_id %gtc1879 %u32_id_1
       %gtc1881 = OpUGreaterThanEqual %bool_id %gtc1879 %gtcap_1000
       %gtc1882 = OpLogicalOr %bool_id %243 %gtc1881
               OpBranchConditional %gtc1882 %82 %75
         %75 = OpLabel
               OpBranch %76
         %76 = OpLabel
       ...
       %gtc1883 = OpPhi %u32_id %u32_id_0 %75 %gtc1884 %79
               OpLoopMerge %80 %79 None
               OpBranch %77
         %77 = OpLabel
        %260 = OpULessThan %bool_id %259 %127
        %261 = OpLogicalNot %bool_id %260
       %gtc1884 = OpIAdd %u32_id %gtc1883 %u32_id_1
       %gtc1885 = OpUGreaterThanEqual %bool_id %gtc1883 %gtcap_1000
       %gtc1886 = OpLogicalOr %bool_id %261 %gtc1885
               OpBranchConditional %gtc1886 %80 %78
         %78 = OpLabel
        ...
        %387 = OpULessThan %bool_id %385 %u32_id_6
               OpBranch %83
         %83 = OpLabel
       %gtc1875 = OpIAdd %u32_id %gtc1874 %u32_id_1
       %gtc1878 = OpULessThan %bool_id %gtc1874 %gtcap_1000
       %gtc1877 = OpLogicalAnd %bool_id %387 %gtc1878
               OpBranchConditional %gtc1877 %71 %84
         %84 = OpLabel
       ...
       %gtc1887 = OpPhi %u32_id %u32_id_0 %85 %gtc1888 %88
        ...
        %571 = OpSLessThan %bool_id %467 %u32_id_63
               OpBranch %88
         %88 = OpLabel
       %gtc1888 = OpIAdd %u32_id %gtc1887 %u32_id_1
       %gtc1891 = OpULessThan %bool_id %gtc1887 %gtcap_1000
       %gtc1890 = OpLogicalAnd %bool_id %571 %gtc1891
               OpBranchConditional %gtc1890 %86 %89
         %89 = OpLabel
