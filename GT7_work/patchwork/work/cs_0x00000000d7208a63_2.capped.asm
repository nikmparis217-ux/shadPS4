...
%buf3_dword_off = OpShiftRightLogical %u32_id %buf3_off %u32_id_2
      ...
      %ud_10 = OpLoad %u32_id %163
        ...
        %176 = OpUGreaterThan %bool_id %ud_0 %175
         ...
         %63 = OpLabel
        %178 = OpIMul %u32_id %175 %u32_id_14
       ...
       %gtc1043 = OpPhi %u32_id %u32_id_0 %66 %gtc1044 %71
        ...
        %270 = OpIEqual %bool_id %231 %u32_id_14
        %271 = OpSelect %u32_id %270 %208 %269
        %273 = OpIEqual %bool_id %231 %u32_id_15
        %274 = OpSelect %u32_id %273 %207 %271
       ...
       %1035 = OpLogicalAnd %bool_id %176 %1034
        ...
        %107 = OpLabel
       %1036 = OpIMul %u32_id %909 %u32_id_14
