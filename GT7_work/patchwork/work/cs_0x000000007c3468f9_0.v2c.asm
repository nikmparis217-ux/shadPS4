...
%buf1_dword_off = OpShiftRightLogical %u32_id %buf1_off %u32_id_2
       ...
       %gtc2361 = OpPhi %u32_id %u32_id_0 %74 %gtc2362 %91
       ...
       %gtc2365 = OpPhi %u32_id %u32_id_0 %76 %gtc2366 %89
               OpLoopMerge %90 %89 None
               OpBranch %78
         %78 = OpLabel
        %291 = OpULessThan %bool_id %290 %137
        %292 = OpLogicalNot %bool_id %291
       %gtc2367 = OpUGreaterThanEqual %bool_id %gtc2365 %gt_lim100000
       %gtc2368 = OpLogicalOr %bool_id %292 %gtc2367
               OpBranchConditional %gtc2368 %90 %79
         %79 = OpLabel
       ...
       %gtc2369 = OpPhi %u32_id %u32_id_0 %79 %gtc2370 %87
               OpLoopMerge %88 %87 None
               OpBranch %81
         %81 = OpLabel
        %315 = OpULessThan %bool_id %314 %137
        %316 = OpLogicalNot %bool_id %315
       %gtc2371 = OpUGreaterThanEqual %bool_id %gtc2369 %gt_lim100000
       %gtc2372 = OpLogicalOr %bool_id %316 %gtc2371
               OpBranchConditional %gtc2372 %88 %82
         %82 = OpLabel
        ...
        %471 = OpBitcast %u32_id %470
               OpBranch %87
         %87 = OpLabel
       %gtc2370 = OpIAdd %u32_id %gtc2369 %u32_id_1
        ...
        %504 = OpBitcast %u32_id %503
               OpBranch %89
         %89 = OpLabel
       %gtc2366 = OpIAdd %u32_id %gtc2365 %u32_id_1
        ...
        %523 = OpULessThan %bool_id %521 %u32_id_6
               OpBranch %91
         %91 = OpLabel
       %gtc2362 = OpIAdd %u32_id %gtc2361 %u32_id_1
       %gtc2363 = OpULessThan %bool_id %gtc2361 %gt_lim100000
       %gtc2364 = OpLogicalAnd %bool_id %523 %gtc2363
               OpBranchConditional %gtc2364 %75 %92
         %92 = OpLabel
       ...
       %gtc2373 = OpPhi %u32_id %u32_id_0 %93 %gtc2374 %96
        ...
        %745 = OpSLessThan %bool_id %608 %u32_id_63
               OpBranch %96
         %96 = OpLabel
       %gtc2374 = OpIAdd %u32_id %gtc2373 %u32_id_1
       %gtc2375 = OpULessThan %bool_id %gtc2373 %gt_lim100000
       %gtc2376 = OpLogicalAnd %bool_id %745 %gtc2375
               OpBranchConditional %gtc2376 %94 %97
         %97 = OpLabel
