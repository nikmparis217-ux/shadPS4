...
%buf7_dword_off = OpShiftRightLogical %u32_id %buf7_off %u32_id_2
       ...
       %gtc3570 = OpPhi %u32_id %u32_id_0 %90 %gtc3571 %94
       ...
       %gtc3571 = OpIAdd %u32_id %gtc3570 %u32_id_1
       %gtc3572 = OpUGreaterThanEqual %bool_id %gtc3570 %gtcap_1000
       %gtc3573 = OpLogicalOr %bool_id %476 %gtc3572
               OpBranchConditional %gtc3573 %95 %93
         %93 = OpLabel
       ...
       %gtc3574 = OpPhi %u32_id %u32_id_0 %103 %gtc3575 %107
               OpLoopMerge %108 %107 None
               OpBranch %105
        %105 = OpLabel
        %645 = OpSLessThan %bool_id %644 %622
        %646 = OpLogicalNot %bool_id %645
       %gtc3575 = OpIAdd %u32_id %gtc3574 %u32_id_1
       %gtc3576 = OpUGreaterThanEqual %bool_id %gtc3574 %gtcap_1000
       %gtc3577 = OpLogicalOr %bool_id %646 %gtc3576
               OpBranchConditional %gtc3577 %108 %106
        %106 = OpLabel
       ...
       %gtc3578 = OpPhi %u32_id %u32_id_0 %108 %gtc3579 %112
               OpLoopMerge %113 %112 None
               OpBranch %110
        %110 = OpLabel
       %1091 = OpSLessThan %bool_id %1090 %1077
       %1092 = OpLogicalNot %bool_id %1091
       %gtc3579 = OpIAdd %u32_id %gtc3578 %u32_id_1
       %gtc3580 = OpUGreaterThanEqual %bool_id %gtc3578 %gtcap_1000
       %gtc3581 = OpLogicalOr %bool_id %1092 %gtc3580
               OpBranchConditional %gtc3581 %113 %111
        %111 = OpLabel
       ...
       %gtc3582 = OpPhi %u32_id %u32_id_0 %118 %gtc3583 %122
               OpLoopMerge %123 %122 None
               OpBranch %120
        %120 = OpLabel
       %1613 = OpSLessThan %bool_id %1612 %1596
       %1614 = OpLogicalNot %bool_id %1613
       %gtc3583 = OpIAdd %u32_id %gtc3582 %u32_id_1
       %gtc3584 = OpUGreaterThanEqual %bool_id %gtc3582 %gtcap_1000
       %gtc3585 = OpLogicalOr %bool_id %1614 %gtc3584
               OpBranchConditional %gtc3585 %123 %121
        %121 = OpLabel
       ...
       %gtc3586 = OpPhi %u32_id %u32_id_0 %125 %gtc3587 %129
               OpLoopMerge %130 %129 None
               OpBranch %127
        %127 = OpLabel
       %2160 = OpSLessThan %bool_id %2159 %2096
       %2161 = OpLogicalNot %bool_id %2160
       %gtc3587 = OpIAdd %u32_id %gtc3586 %u32_id_1
       %gtc3588 = OpUGreaterThanEqual %bool_id %gtc3586 %gtcap_1000
       %gtc3589 = OpLogicalOr %bool_id %2161 %gtc3588
               OpBranchConditional %gtc3589 %130 %128
        %128 = OpLabel
       ...
       %gtc3590 = OpPhi %u32_id %u32_id_0 %143 %gtc3591 %147
               OpLoopMerge %148 %147 None
               OpBranch %145
        %145 = OpLabel
       %2821 = OpSLessThan %bool_id %2820 %2786
       %2822 = OpLogicalNot %bool_id %2821
       %gtc3591 = OpIAdd %u32_id %gtc3590 %u32_id_1
       %gtc3592 = OpUGreaterThanEqual %bool_id %gtc3590 %gtcap_1000
       %gtc3593 = OpLogicalOr %bool_id %2822 %gtc3592
               OpBranchConditional %gtc3593 %148 %146
        %146 = OpLabel
