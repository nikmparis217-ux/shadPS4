...
; Schema: 0
 ...
 %u32vec4_id = OpTypeVector %u32_id 4
   ...
   %gtcap_65536 = OpConstant %u32_id 65536
...
%buf2_dword_off = OpShiftRightLogical %u32_id %buf2_off %u32_id_2
       ...
       %ud_3 = OpLoad %u32_id %104
        ...
        %gtc385 = OpPhi %u32_id %u32_id_0 %70 %gtc386 %78
        ...
        %gtc386 = OpIAdd %u32_id %gtc385 %u32_id_1
        %gtc387 = OpUGreaterThanEqual %bool_id %gtc385 %gtcap_65536
        %gtc388 = OpLogicalOr %bool_id %287 %gtc387
               OpBranchConditional %gtc388 %79 %73
         %73 = OpLabel
